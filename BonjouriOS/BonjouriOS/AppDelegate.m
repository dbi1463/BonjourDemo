...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions {
	...
	BonjourDiscoveredServicesViewController* controller = [[BonjourDiscoveredServicesViewController alloc] initWithNibName:@"BonjourDiscoveredServicesView" bundle:nil];
